...
if (!file.exists(here(wd, data_filename))) {
  osf_retrieve_file("jrq8u") |> 
    osf_download(path = here(wd),
                 conflicts = "overwrite") 
}

## Load the data
exp1_rawdata <- here(wd, data_filename) |> load()
...
exp1.wordlist <- read.csv("./materials/experiment1/frequency-effects_experiment1_word-lists_final.csv")
...
exp2.wordlist <- read.csv("./materials/experiment2/frequency-effects_experiment2_word-lists_final.csv")
