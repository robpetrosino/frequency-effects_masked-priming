...
available in the downloadable supplemental material) show a clear
replication of for four basic benchmark results in masked priming:
detection of (i) identity and (ii) morphological priming with (iii) no
evidence of semantic priming, as well as (iv) a proportionality effect
of identity priming and prime duration.
...
Interestingly, in addition to the reliable FAE, our results align with
previous studies (Cayado, Wray, and Stockall 2023; Petrosino, Sprouse,
and Almeida 2023) in showing a minimal inhibitory masked repetition
priming effect for non-words, with very high precision. The 95\%
confidence interval (CI) suggests that the plausible range for the
