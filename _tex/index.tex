...
statistics of the experiment. For experiment 2, we followed the same
statistical analysis as experiment 1. A 2x2 repeated-measures ANOVA
(condition, 2 levels: high vs.~low; primetype, 2 levels: unrelated
vs.~repetition) revealed significant main effects (condition:
...
\emph{t}(1923)=-3.53, \emph{p}=.0004). As for the word error analysis,
we found significant priming effects in the form of fewer errors in
repeated compared to unrelated trials in the all conditions (high:
\emph{t}(1923)=9.30, \emph{p}\textless.0001; low: \emph{t}(1923)=15.8,
