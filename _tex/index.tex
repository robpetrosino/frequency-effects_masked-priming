...
\phantomsection\label{cell-fig-power}
\begin{figure}[H]

\centering{

\includegraphics{index_files/figure-pdf/fig-power-1.pdf}
...
for each condition. Table~\ref{tbl-statsResults} below reports the
...
\caption{\label{tbl-statsResults}Experiment 1. Summary of the word
